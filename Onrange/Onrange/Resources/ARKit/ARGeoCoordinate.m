...
+ (ARGeoCoordinate *)coordinateWithLocation:(CLLocation *)location locationTitle:(NSString *) titleOfLocation qtCheckin:(NSString *)qtCheckin andTipoLocal:(NSInteger)tipoLocal
{
    ...
    [newCoordinate setQtCheckin: qtCheckin];
    [newCoordinate setTipoLocal:tipoLocal];
...
{
	ARGeoCoordinate *newCoordinate = [ARGeoCoordinate coordinateWithLocation:location locationTitle:@"" qtCheckin:@"" andTipoLocal:0];
