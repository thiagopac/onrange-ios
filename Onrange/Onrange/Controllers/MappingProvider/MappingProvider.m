...
+(RKMapping *)promoMapping {
    ...
    [mapping addAttributeMappingsFromArray:@[@"id_promo", @"local", @"nome", @"descricao", @"dt_inicio", @"dt_fim", @"lote", @"codigo_promo", @"dt_utilizacao",@"dt_promo", @"dt_visualizacao",@"dt_usuario",@"id_codigo_promo",@"nao_lido"]];
    return mapping;
}
