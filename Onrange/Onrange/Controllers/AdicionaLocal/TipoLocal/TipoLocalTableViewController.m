...
- (void)viewDidLoad
{
    ...
    arrTiposLocais = @[@"Balada (Boate, pub, espaço de dança, etc)",@"Gastronomia (Bar, restaurante, café, sorveteria, etc)",@"Eventos (Festa, show, feira, exposição, etc)",@"Lazer e turismo (Clube, cinema, parque, hotel, etc)"];
