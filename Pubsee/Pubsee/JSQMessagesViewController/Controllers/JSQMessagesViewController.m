...
- (void)jsq_configureMessagesViewController
{
    ...
    self.inputToolbar.contentView.textView.placeHolder = NSLocalizedString(@"Mensagem", @"Placeholder text for the message input text view");
...
//alinhamento horizontal do nome de quem envia a mensagem oponente
